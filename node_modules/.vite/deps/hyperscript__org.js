...
var require_hyperscript_min = __commonJS({
  "node_modules/hyperscript.org/dist/_hyperscript.min.js"(exports, module) {
    (function(e, t) {
      const r = t(e);
      ...
      const _n = class _n {
        static isValidCSSClassChar(e2) {
          return _n.isAlpha(e2) || _n.isNumeric(e2) || e2 === "-" || e2 === "_" || e2 === ":";
        }
        static isValidCSSIDChar(e2) {
          return _n.isAlpha(e2) || _n.isNumeric(e2) || e2 === "-" || e2 === "_" || e2 === ":";
        }
        static isWhitespace(e2) {
          return e2 === " " || e2 === "	" || _n.isNewline(e2);
        }
        ...
        static tokenize(e2, t2) {
          ...
          while (o2 < a2.length) {
            if (q() === "-" && N() === "-" && (_n.isWhitespace(I(2)) || I(2) === "" || I(2) === "-") || q() === "/" && N() === "/" && (_n.isWhitespace(I(2)) || I(2) === "" || I(2) === "/")) {
              h2();
            } else if (q() === "/" && N() === "*" && (_n.isWhitespace(I(2)) || I(2) === "" || I(2) === "*")) {
              v2();
            } else {
              if (_n.isWhitespace(q())) {
                r2.push(A());
              } else if (!R() && q() === "." && (_n.isAlpha(N()) || N() === "{" || N() === "-")) {
                r2.push(d2());
              } else if (!R() && q() === "#" && (_n.isAlpha(N()) || N() === "{")) {
                r2.push(k2());
              } else if (q() === "[" && N() === "@") {
                r2.push(E2());
              } else if (q() === "@") {
                r2.push(T2());
              } else if (q() === "*" && _n.isAlpha(N())) {
                r2.push(y2());
              } else if (_n.isAlpha(q()) || !f2() && _n.isIdentifierChar(q())) {
                r2.push(x2());
              } else if (_n.isNumeric(q())) {
                r2.push(g2());
              } else if (!f2() && (q() === '"' || q() === "`")) {
                r2.push(w2());
              } else if (!f2() && q() === "'") {
                if (_n.isValidSingleQuoteStringStart(r2)) {
                  r2.push(w2());
                } else {
                  r2.push(b2());
                }
              } else if (_n.OP_TABLE[q()]) {
                if (l2 === "$" && q() === "{") {
                  c2++;
                }
                if (q() === "}") {
                ...
                r2.push(b2());
              } else if (f2() || _n.isReservedChar(q())) {
          ...
          function d2() {
            ...
            if (q() === "{") {
              ...
              while (_n.isValidCSSClassChar(q())) {
                t3 += C();
              }
            }
            e3.value = t3;
          ...
          function T2() {
            ...
            if (q() === "=") {
              ...
              if (q() === '"' || q() === "'") {
                let e4 = w2();
                t3 += e4.value;
              } else if (_n.isAlpha(q()) || _n.isNumeric(q()) || _n.isIdentifierChar(q())) {
                let e4 = x2();
                t3 += e4.value;
              }
            }
          ...
          function x2() {
            ...
            var t3 = C();
            while (_n.isAlpha(q()) || _n.isNumeric(q()) || _n.isIdentifierChar(q())) {
              t3 += C();
            }
            if (q() === "!" && t3 === "beep") {
              t3 += C();
          ...
          function b2() {
            var e3 = m2();
            var t3 = C();
            while (q() && _n.OP_TABLE[t3 + q()]) {
              t3 += C();
            }
            e3.type = _n.OP_TABLE[t3];
            e3.value = t3;
            e3.end = o2;
            return e3;
          }
          function w2() {
            ...
            while (q() && q() !== t3) {
              if (q() === "\\") {
                ...
                if (t4 === "b") {
                  ...
                  const t5 = S2();
                  if (Number.isNaN(t5)) {
                    throw Error("Invalid hexadecimal escape at " + _n.positionString(e3));
                  }
            ...
            if (q() !== t3) {
              throw Error("Unterminated string at " + _n.positionString(e3));
            } else {
              C();
            }
            e3.value = r3;
          ...
          function R() {
            return _n.isAlpha(l2) || _n.isNumeric(l2) || l2 === ")" || l2 === '"' || l2 === "'" || l2 === "`" || l2 === "}" || l2 === "]";
          }
          function A() {
            var e3 = p2("WHITESPACE");
            var t3 = "";
            while (q() && _n.isWhitespace(q())) {
              if (_n.isNewline(q())) {
                s2 = 0;
                u2++;
              }
        ...
        tokenize(e2, t2) {
          return _n.tokenize(e2, t2);
        }
      };
      __publicField(_n, "OP_TABLE", { "+": "PLUS", "-": "MINUS", "*": "MULTIPLY", "/": "DIVIDE", ".": "PERIOD", "..": "ELLIPSIS", "\\": "BACKSLASH", ":": "COLON", "%": "PERCENT", "|": "PIPE", "!": "EXCLAMATION", "?": "QUESTION", "#": "POUND", "&": "AMPERSAND", $: "DOLLAR", ";": "SEMI", ",": "COMMA", "(": "L_PAREN", ")": "R_PAREN", "<": "L_ANG", ">": "R_ANG", "<=": "LTE_ANG", ">=": "GTE_ANG", "==": "EQ", "===": "EQQ", "!=": "NEQ", "!==": "NEQQ", "{": "L_BRACE", "}": "R_BRACE", "[": "L_BRACKET", "]": "R_BRACKET", "=": "EQUALS" });
      let n = _n;
      class i {
      ...
      class a {
        ...
        requireElement(e2, t2, r2, n2) {
          ...
          if (!i2) a.raiseParseError(t2, r2 || "Expected " + e2);
          return i2;
        }
        parseAnyOf(e2, t2) {
        ...
        parseHyperScript(e2) {
          ...
          if (e2.hasMore()) this.raiseParseError(e2);
          if (t2) return t2;
        }
        setParent(e2, t2) {
          if (typeof e2 === "object") {
      ...
      const _o = class _o {
        constructor(e2, t2) {
          __publicField(this, "HALT", _o.HALT);
          ...
          __publicField(this, "hyperscriptUrl", "document" in e && document.currentScript ? document.currentScript.src : null);
          this.lexer = e2 ?? new n();
        ...
        parse(e2) {
          ...
          if (this.parser.commandStart(n2.currentToken())) {
            ...
            if (n2.hasMore()) r2.raiseParseError(n2);
        ...
        getRootNode(e2) {
          if (e2 && e2 instanceof Node) {
            ...
            if (t2 instanceof Document || t2 instanceof ShadowRoot) return t2;
          }
          return document;
        }
      ...
      const c = new Proxy({}, { get(e2, t2) {
        ...
        if (t2 === "then" || t2 === "asyncWrapper") {
          ...
          if (!isNaN(t2)) {
            ...
            let e3 = (_a = document.cookie.split("; ").find((e4) => e4.startsWith(t2 + "="))) == null ? void 0 : _a.split("=")[1];
            if (e3) {
      ...
      function T(t2) {
        ...
        t2.addFeature("behavior", function(t3, r3, n2) {
          if (!n2.matchToken("behavior")) return;
        ...
        t2.addFeature("install", function(t3, r3, n2) {
          if (!n2.matchToken("install")) return;
          var i2 = t3.requireElement("dotOrColonPath", n2).evaluate();
          var a3 = i2.split(".");
          ...
          return s3 = { install: function(t4, n3) {
            r3.unifiedEval({ args: [o2], op: function(r4, o3) {
              ...
              for (var u3 = 0; u3 < a3.length; u3++) {
                s4 = s4[a3[u3]];
                if (typeof s4 !== "object" && typeof s4 !== "function") throw new Error("No such behavior defined as " + i2);
              }
              if (!(s4 instanceof Function)) throw new Error(i2 + " is not a behavior");
              s4(t4, n3, o3);
        ...
        t2.addCommand("wait", function(e2, t3, r3) {
          ...
          if (r3.matchToken("for")) {
            ...
            n2 = { event: i2, on: o2, args: [o2], op: function(e3, r4) {
              var n3 = r4 ? r4 : e3.me;
              if (!(n3 instanceof EventTarget)) throw new Error("Not a valid event target: " + this.on.sourceFor());
          ...
          if (n2.type === "queryRef") {
            o2 = { op: function(e3) {
              ...
              while (r4 = u3.exec(n2.css)) {
                if (r4[1] === "") i3 = r4[2].trim();
                else if (r4[1] === "#") o3 = r4[2].trim();
                else s3.push(r4[2].trim());
              }
              var l3 = document.createElement(i3);
              if (o3 !== void 0) l3.id = o3;
        ...
        t2.addCommand("default", function(e2, t3, r3) {
          if (!r3.matchToken("default")) return;
        ...
        t2.addCommand("continue", function(e2, t3, r3) {
          if (!r3.matchToken("continue")) return;
        ...
        t2.addCommand("append", function(e2, t3, r3) {
          if (!r3.matchToken("append")) return;
          var n2 = null;
          var i2 = e2.requireElement("expression", r3);
        ...
        function g2(e2, t3, r3) {
          ...
          if (r3.matchToken("inclusive")) n2.includeEnd = true;
          else if (r3.matchToken("exclusive")) n2.includeStart = false;
          return n2;
        }
        class b2 {
          constructor(e2, t3) {
          ...
          next() {
            ...
            if (e2 === null) return { done: true };
            else return { value: e2 };
          }
        }
        class w2 {
          constructor(e2, t3, r3) {
        ...
        t2.addCommand("pick", (e2, t3, r3) => {
          ...
          if (r3.matchToken("item") || r3.matchToken("items") || r3.matchToken("character") || r3.matchToken("characters")) {
            ...
            return { args: [i2, n2.from, n2.to], op(e3, r4, i3, a3) {
              if (n2.toEnd) a3 = r4.length;
              if (!n2.includeStart) i3++;
              if (n2.includeEnd) a3++;
              if (a3 == null || a3 == void 0) a3 = i3 + 1;
        ...
        t2.addCommand("increment", function(e2, t3, r3) {
          if (!r3.matchToken("increment")) return;
          var n2;
        ...
        t2.addCommand("decrement", function(e2, t3, r3) {
          if (!r3.matchToken("decrement")) return;
          var n2;
          var i2 = e2.parseElement("assignableExpression", r3);
          if (r3.matchToken("by")) {
            n2 = e2.requireElement("expression", r3);
          ...
          var u3 = { url: n2, argExpressions: a3, args: [n2, a3], op: function(e3, r4, n3) {
            ...
            return fetch(r4, n3).then(function(r5) {
              ...
              return r5.text().then(function(r6) {
                if (s3) r6 = t3.convertValue(r6, s3);
                if (o2 === "html") r6 = t3.convertValue(r6, "Fragment");
                e3.result = r6;
                t3.triggerEvent(e3.me, "fetch:afterRequest", { result: r6 });
                c3 = true;
                return t3.findNext(u3, e3);
      ...
      function y(e2) {
                ...
                t3.forEach(n4, function(n5) {
                  t3.implicitLoop(r3, function(r4) {
                    if (u2) {
                      ...
                      if (i4) {
                        if (r4 instanceof Element) r4.classList.add(n5.className);
                      } else {
                        if (r4 instanceof Element) r4.classList.remove(n5.className);
                      }
                      e4.result = null;
                    } else {
                      if (r4 instanceof Element) r4.classList.add(n5.className);
        ...
        function a2(t3, r2, n3, i3) {
          ...
          if (a3 instanceof Element || a3 instanceof HTMLDocument) {
            while (a3.firstChild) a3.removeChild(a3.firstChild);
        ...
        e2.addCommand("measure", function(e3, t3, r2) {
          if (!r2.matchToken("measure")) return;
          var n3 = o2(e3, t3, r2);
          var i3 = [];
          if (!e3.commandBoundary(r2.currentToken())) do {
          ...
          return { properties: i3, args: [n3], op: function(e4, r3) {
            ...
            t3.forEach(i3, function(t4) {
              if (t4 in e4.result) e4.locals[t4] = e4.result[t4];
              else throw "No such measurement as " + t4;
            });
            return t3.findNext(this, e4);
          } };
        });
        ...
        r.conversions["Fragment"] = function(t3) {
          ...
          e2.runtime.implicitLoop(t3, function(e3) {
            if (e3 instanceof Node) r2.append(e3);
            else {
...
//# sourceMappingURL=hyperscript__org.js.map
